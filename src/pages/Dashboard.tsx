            ...
            <div className="lg:col-span-2 lg:border-r-2 border-primary p-6 sm:p-8 lg:p-12 relative">
              ...
              <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-10">
                <img 
                  src={m9OctopusLogo} 
                  alt="M9 Octopus" 
                  className="w-36 sm:w-40 lg:w-48 h-auto opacity-90 hover:opacity-100 transition-all [filter:invert(83%)_sepia(60%)_saturate(1000%)_hue-rotate(10deg)_brightness(105%)] theme-inverted:[filter:invert(83%)_sepia(60%)_saturate(1000%)_hue-rotate(10deg)_brightness(105%)] theme-inverted:scale-110"
                />
              </div>
